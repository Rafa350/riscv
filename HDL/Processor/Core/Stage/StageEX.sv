module StageEX (
    ...
    input  ProcessorDefs::Data      i_instIMM,     // Valor IMM de la instruccio
    input  ProcessorDefs::CSRAddr   i_instCSR,     // Valor CSR de la instruccio
    input  ProcessorDefs::Data      i_dataRS1,     // Valor del registre X[RS1]
    input  ProcessorDefs::Data      i_dataRS2,     // Valor del registre X[RS2]
    input  ProcessorDefs::InstAddr  i_pc,          // Adressa de la instruccio
    input  CoreDefs::DataASel       i_operandASel, // Seleccio del operand A
    input  CoreDefs::DataBSel       i_operandBSel, // Seleccio del operand B
    input  CoreDefs::ResultSel      i_resultSel,   // Seleccio del resultat
    input  CoreDefs::AluOp          i_aluControl,  // Operacio en la unitat ALU
    input  CoreDefs::CsrOp          i_csrControl,  // Operacio en la unitat CSR
    ...
    output ProcessorDefs::Data      o_dataR,       // Dades del resultat
    output ProcessorDefs::Data      o_dataB);      // Dades B
    ...
    operandASelector (
        ...
        .i_input2 (ProcessorDefs::Data'(0)),                 // Valor 0
        .i_input3 (ProcessorDefs::Data'(i_pc)),              // Valor de PC
    ...
    operandBSelector (
        ...
        .i_input1 (i_instIMM),                // Valor inmediat
        .i_input2 (ProcessorDefs::Data'(4)),                 // Valor 4
    ...
    ProcessorDefs::Data csrUnit_data;
    ...
    csrUnit (
        ...
        .i_op          (i_isValid ? i_csrControl : CoreDefs::CsrOp_NOP),
        .i_csr         (i_instCSR),
    ...
    ProcessorDefs::Data aluUnit_result;
    ...
    ProcessorDefs::Data resultSelector_output;
